...
public static class MetadataHelpers
{
    ...
    public static ChartConfig GetOscillatorConfig() => GetOscillatorConfig(0, 100);
    public static ChartConfig GetOscillatorConfig(float min, float max) => GetOscillatorConfig(min, max, 80); // default upper
    public static ChartConfig GetOscillatorConfig(float min, float max, float upperThreshold) => GetOscillatorConfig(min, max, upperThreshold, 20); // default lower
    ...
    public static List<IndicatorResultConfig> GetPriceBandResults(string name) => GetPriceBandResults(name, ChartColors.StandardOrange);
